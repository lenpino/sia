...
%>
		<div id="header_cont">
			...
			<div id="header_barra">
				...
				<%if(flag){ %>
					<div class="header_col_2" style="padding-top:12px;"><img src="<%=basePath %>imagenes/pxGris.png" border="0"/></div>
					<div class="header_col_2" style="font-size:12px;"><a style="color:yellow;" href="<%=basePath%>fce?reqName=prglogoff" title="Salir">Cerrar Sesi&oacute;n</a></div>
				<%}%>	
			</div>
		</div>
