...
%>
		<div id="header_cont">
			...
			<div id="header_barra">
				...
				<div class="header_col_2"><a class="secciones" style="color: #FFFFFF;" href="javascript:void(0);">Chat</a></div>
				<div class="header_col_1"><img src="<%=basePath %>imagenes/email.png" border="0"/></div>
				<div class="header_col_2"><a class="secciones" style="color: #FFFFFF;" href="javascript:void(0);">Contacto</a></div>
				<div class="header_col_3"><img src="<%=basePath %>imagenes/telefono.png" border="0"/></div>
				<div class="header_col_2" style="color: #FFFFFF;"><span class="secciones">(56)2 2xxxxxxx</span></div>
